...
void VulkanDeviceContext::CreateLogicalDevice()
{
    ...
    VkPhysicalDevice8BitStorageFeatures storage8Feature = {};
    storage8Feature.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES;
    storage8Feature.storageBuffer8BitAccess = VK_TRUE;
    meshFeature.pNext = &storage8Feature;
    VkPhysicalDevice16BitStorageFeatures storage16Feature = {};
    storage16Feature.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_16BIT_STORAGE_FEATURES;
    storage16Feature.storageBuffer16BitAccess = VK_TRUE;
    storage8Feature.pNext = &storage16Feature;
    VkPhysicalDeviceShaderFloat16Int8Features float16int8Feature = {};
    float16int8Feature.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES;
    float16int8Feature.shaderFloat16 = VK_TRUE;
    float16int8Feature.shaderInt8 = VK_TRUE;
    storage16Feature.pNext = &float16int8Feature;
