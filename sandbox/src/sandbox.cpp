...
public:
    ...
    {
        m_vertex_array = hazel::VertexArray::create();
        ...
        m_vertex_buffer = hazel::VertexBuffer::create(vertices, sizeof(vertices));
        ...
        m_index_buffer = hazel::IndexBuffer::create(indices, 3);
