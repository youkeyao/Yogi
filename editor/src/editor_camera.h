...
public:
    ...
    {
        m_camera_component.is_ortho = is_ortho;
        recalculate_projection();
        recalculate_view();
    }

    const TransformComponent &get_transform_component()
    {
        return m_camera_component.is_ortho ? m_ortho_transform_component : m_perspective_transform_component;
    }
