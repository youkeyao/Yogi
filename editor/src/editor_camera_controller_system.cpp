...
namespace Yogi {
    ...
    void EditorCameraControllerSystem::on_update(Timestep ts, const Ref<Entity>& editor_camera)
    {
        bool is_moved = false;
    ...
    void EditorCameraControllerSystem::on_event(Event& e, const Ref<Entity>& editor_camera)
    {
    ...
    bool EditorCameraControllerSystem::on_mouse_scrolled(MouseScrolledEvent& e, const Ref<Entity>& editor_camera)
    {
    ...
    bool EditorCameraControllerSystem::on_window_resized(WindowResizeEvent& e, const Ref<Entity>& editor_camera)
    {
        CameraComponent& camera = editor_camera->get_component<CameraComponent>();
