    ...
    for (const auto &element : layout) {
        ...
        case ShaderDataType::Float4: {
            ...
            glVertexAttribPointer(
                m_vertex_buffer_id, element.count, ShaderDataType_to_OpenGLBaseType(element.type), GL_FALSE,
                layout.get_stride(), (const void *)(uintptr_t)element.offset);
            m_vertex_buffer_id++;
            break;
        }
        case ShaderDataType::Int:
        ...
        case ShaderDataType::Bool: {
            ...
            glVertexAttribIPointer(
                m_vertex_buffer_id, element.count, ShaderDataType_to_OpenGLBaseType(element.type), layout.get_stride(),
        ...
        case ShaderDataType::Mat4: {
            ...
            for (uint8_t i = 0; i < count; i++) {
                glEnableVertexAttribArray(m_vertex_buffer_id);
                glVertexAttribPointer(
                    m_vertex_buffer_id, count, ShaderDataType_to_OpenGLBaseType(element.type), GL_FALSE, layout.get_stride(),
